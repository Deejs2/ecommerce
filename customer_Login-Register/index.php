...
<head>
  ...
  <link rel="stylesheet" href="customer_Login-Register/img/BISHAL9.jpgstyle.css">
</head>
    ...
    <div class="container py-5 h-100">
      <div class="row d-flex align-items-center justify-content-center h-100">
        <div class="col-md-8 col-lg-7 col-xl-6">
          <img src="customer_Login-Register/img/BISHAL9.jpg" class="img-fluid" alt="Phone image" height="300px" width="600px">
        </div>
        <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
          <form action="customer_Login-Register/login.php" method="post">
            <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-3 mt-3">Login for Customer</p>
          ...
          <p align ="center">I don't have any account <a href="?page=register-customer" class="text-warning" style="font-weight:600;color-red: blue;text-decoration:none;">Register Here</a></p>
        </div>
      </div>
    </div>
  </section>
