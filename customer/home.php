    ...
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">
        ...
        <ul style="list-style-type: none; text-align: left;">
          <li>Wireless Connectivity : Bluetooth</li>
          <li>Bluetooth : Yes</li>
          <li>Cable Length : 0.5m - 0.9m</li>
          <li>Box Content : 1 p47 headphone</li>
        </ul>
      </p>
      <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
      <a href="?page=product&action=cart"><button type="button" class="btn btn-primary btn-lg px-4 me-sm-3">Buy Now</button></a>
      </div>
    </div>
